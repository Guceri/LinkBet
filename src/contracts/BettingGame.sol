...
//import smart contract for random number generation
import "@chainlink/contracts/src/v0.6/VRFConsumerBase.sol";
/* !UPDATE, import aggregator contract */
import "@chainlink/contracts/src/v0.6/interfaces/AggregatorV3Interface.sol"; 

//inherit from the random number smart contract
contract BettingGame is VRFConsumerBase {
  ...
  //Network: Rinkeby Link Information
  ...
  //keyHash(network specific) - helps identify which chainlink oracle we will use to get a random number
  ...
  //reference the last game that was decided on (may be different than gameId as bets are being processed)
  uint256 public lastGameId;
  //we use payable because we are using the admin.transfer() function
  ...
  /**
   *Constructor inherits VRFConsumerBase. Addresses are listed above
   */
  ...
  /**!UPDATE
   * LINK TEMPLATE FUNCTION to get price data
  ...
  function game(uint256 bet, uint256 seed) public payable returns (bool) {
    ...
    */
    ...
    //each bet has unique id and is mapped to the games mapping using the Game struct
    ...
    //When an internal function is used (getRandomNumber), we need to return a bool
    return true;
  }
  //===================================================================================================================
  //===================================================================================================================
   ...
   *we set this to internal (it is public in the template) which only allows this contract to call it.
   *used by game()
   */
  ...
  function fulfillRandomness(bytes32 /*requestId*/, uint256 randomness) internal override {
    ...
    //randomness.mod(2) //should return a value of of 0 or 1
   ...
   */
   //onlyVRF can call the fulfillrandomness function (which uses verdict function)
  function verdict(uint256 random) public payable onlyVFRC {
    //check bets from latest betting round, one by one
    //the for loop allows for orderly processing of bets
    //ie. possible to make multiple bets before randomResults comeback and verdict is decided
    //this happens when multiple people are using the app at the same time
